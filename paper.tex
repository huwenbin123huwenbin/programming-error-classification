...
modifications). Romero and Ventura~\cite{romero2013data}
...
Kazemitabaar et al.~\cite{kazemitabaar2024impact} showed that while LLMs
excel at code generation, our DeepSeek-V3 few-shot results demonstrate that
fine-grained error-type classification is a distinct weakness (17.37\%
accuracy), corroborating our finding that LLMs face fundamental limitations
for this task.
...
ineffective in practice, and by prior work showing LLMs struggle with code analysis relative to
generation~\cite{kazemitabaar2024impact,finnie2022robots}.\\
