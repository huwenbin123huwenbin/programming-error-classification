...
Machine learning has been applied to computing education challenges including student performance prediction~\cite{romero2013data}, automated assessment~\cite{pears2007survey}, and personalized feedback~\cite{barbosa2023feedback}. Our work extends this line by focusing specifically on metadata-only classification for runtime verdicts.

\subsection{Large Language Models in Programming}

LLMs have demonstrated strong code capabilities: GPT-4 achieves 67\% pass@1 on HumanEval~\cite{openai2023gpt4}, while specialized models like DeepSeek-V3~\cite{deepseek2024deepseekv3} offer competitive performance. However, their effectiveness on error classification from metadata alone remains unexplored.
...
tasks~\cite{liu2023fewshot}, which would still leave a substantial gap to the
