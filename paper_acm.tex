...
Robust behavioral modeling distinguishes productive from unproductive debugging~\cite{effenberger2021validity}, aligning with cognitive load principles~\cite{sweller2011cognitive}. Process mining approaches~\cite{romero2013data} highlight the value of analyzing interaction sequences over aggregated statistics.
...
identification}~\cite{pears2007survey}. We are not aware of
...
generalize our findings. Recent analyses~\cite{finnie2022robots} have argued that AI will
