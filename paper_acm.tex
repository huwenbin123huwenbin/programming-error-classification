...
LLMs (GPT-4, Claude, DeepSeek-Coder) show strong code capabilities~\cite{raihan2025large,finnie2022robots} but their effectiveness for metadata-only error classification is understudied. LLM error messages often fail to meet formative feedback criteria~\cite{morris2021formative,leerentveld2024not}, motivating controlled ML-LLM comparison.
...
error messages measurably improved novice self-correction rates. Burrows et al.~\\cite{burrows2014eras} established NLP frameworks for evaluating generated feedback quality. Yet our Qwen2.5:3B zero-shot results
...
(CS1QA\cite{lee2022cs1qa}, Blackbox) to test whether the metadata ceiling generalizes to
