...
with 3-shot-per-class prompting reducing accuracy to 64.55\% but improving Macro F1 from 0.5447 to 0.6266.
...
with Macro F1 = 0.5447 (zero-shot; detailed per-class in Table~\ref{tab:llm-analysis});
