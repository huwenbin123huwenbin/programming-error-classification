...
\item \textbf{Supervised ML outperforms frontier LLMs}: Gradient Boosting (95.02\%) exceeds DeepSeek-V3 zero-shot (76.65\%) by 18.4 pp, and Qwen2.5:3B (35.50\%) by 59.5 pp. Even with identical features, GB (92.0\%) surpasses DeepSeek-V3 by 15.4 pp. Execution time is the dominant predictor (8.8 pp accuracy drop when removed).
